  ...
  <div class="content-wrapper" style="margin-left: 0px;">
    ...
    <section class="content">
      ...
      <div class="box" style="margin-top:40px;">
        ...
        <div class="box-body">
 <!--FORM-->
         <form method="post" id="insert_form" action="insert2.php<?php echo "?id=".$scholar_id."&&cid=".$agency_id ;?>" enctype="multipart/form-data">  
            <div class="box-body">
              <div id="sub_error">
            </div>
   ...
   <h5 align="center"><b>NOTE: Please do not include non-academic subjects (such as NSTP,CWTS, ROTC and PE)</b></h6>
   <br />
...
function fileValidation(){
 ...
 <script>
  ...
  html += '<td><input type="number" step=".005" name="item_quantity[]" class="form-control item_quantity" /></td>';
