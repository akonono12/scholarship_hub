...
<div class="wrapper">
  ...
  <div class="content-wrapper" style="margin-left: 0px;">
    ...
    <section class="content-header">
      <h1>
          <form  method="POST" action="<?php echo $_SERVER['PHP_SELF']."?id=".$scholar_id."&&cid=".$agency_id ;?>">
        <div class="form-row">
 ...
 <!--FORM-->
            ...
            <hr/>
              ...
              <div class="form-row">
                <div class="form-group col-md-3">
                  ...
                  <input type="date" class="form-control" id="birthdate" name="bday" placeholder="" required>
                </div>
                <div class="form-group col-md-4">
              ...
              <div class="form-row">
                  ...
                  <div class="form-group col-md-3">
                      ...
                      <input type="number" class="form-control" id="contact" name="contactno" placeholder="" required>
                  </div>
                  <div class="form-group col-md-5">
                    ...
                    <div class="form-group col-md-2">
                      ...
                      <input type="number" class="form-control" id="sibling" name="sibling" placeholder="" required />
                    </div>
              </div>
              <div class="form-row">
                  <div class="form-group col-md-5">
            ...
            <div class="box-body">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-12">
                                            ...
                                            <input type="text" class="form-control" id="fatherocc" name="fatherocc" placeholder="" required >
                                        </div>
                                    </div>
                                    <div class="form-row">
                                        <div class="form-group col-md-12">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-12">
                                            ...
                                            <input type="text" class="form-control" id="motherocc" name="motherocc" placeholder="" required >
                                        </div>
                                    </div>
                                    <div class="form-row">
                                        <div class="form-group col-md-12">
                                            <span for="motheradd">Address <span class="text-danger">*</span></span>
                                            <input type="text" class="form-control" id="motheradd" name="motheradd" placeholder="" required >
                                        </div>
                                    </div>
                                    <div class="form-row">
                                        <div class="form-group col-md-12">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-12">
                                            ...
                                            <input type="number" class="form-control" id="income" name="income" placeholder="" required >
                                        </div>
                                    </div>
                                </div>
                      ...
                      <div class="box-body">
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-2">
                                    ...
                                    <select class="form-control" id="year" name="year" placeholder="" required >
                                        <option></option>
                                    </select>
                                </div>
                                <div class="form-group col-md-2">
                            ...
                            <div class="row">
                              <div class="col-md-6">
                                <div class="form-group ">
                                    ...
                                    <select class="form-control select2" id="college" name="college" placeholder="" required >
                                      <option></option>
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <select class="form-control select2" id="course" name="course" placeholder="" required >
                                        <option></option>
                        ...
                        <div class="box-body">
                       <h5><b><span class="fa fa-cogs"></span>&nbsp;&nbsp;OTHERS</b></h5>
                      <hr/>
                      <div class="box-body">
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                ...
                                <div class="form-group col-md-1">
                                    <span for=""><b>YES</b><span class="text-danger"></span></span>

                                </div>
                                <div class="form-group col-md-1">
                                    <span for=""><b>NO</b><span class="text-danger"></span></span>
                                </div>
                                <div class="form-group col-md-4">
                                    &nbsp;&nbsp;&nbsp;&nbsp;
                                </div>
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    <span>- Indigenous People (IP) (Ethnic Group ex. Ayta, Negritos, Etc.)</span>
                                </div>
                                <div class="form-group col-md-1">
                                    <input type="radio" name="ip" id="is_ip" value="yes" style="display:block;">
                                </div>
                                <div class="form-group col-md-1">
                                    <input type="radio" checked name="ip" value="no" style="display:block;">
                                </div>
                                <div class="form-group col-md-4">
                                    &nbsp;&nbsp;&nbsp;&nbsp;
                                </div>
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    <span>- Solo Parent (Parent of Applicant)</span>
                                </div>
                                <div class="form-group col-md-1">
                                    <input type="radio" name="sp" id="is_sp" value="yes" style="display:block;">
                                </div>
                                <div class="form-group col-md-1">
                                    <input type="radio" checked name="sp" value="no" style="display:block;">
                                </div>
                                <div class="form-group col-md-4">
                                    &nbsp;&nbsp;&nbsp;&nbsp;
                                </div>
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-1">
                                    <input type="radio" name="pwd" id="is_pwd" value="yes" style="display:block;">
                                </div>
                                <div class="form-group col-md-1">
                                    <input type="radio" checked name="pwd" id="is_no_pwd" value="no" style="display:block;">
                                </div>
                                <div class="form-group col-md-4">
                                    &nbsp;&nbsp;&nbsp;&nbsp;
                                </div>
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-5">
                                    <span for="">&nbsp;&nbsp;&nbsp;If yes, select Type of Disability<span class="text-danger"></span></span>
                                    <select class="form-control" id="typeofpwd" disabled name="typeofpwd" placeholder="">
                                        <option></option>
                                        <option>Communication Disability</option>
                                        <option>Disability due to Chronic Illness</option>
                                        <option>Learning Disability</option>
                                        <option>Intellectual Disability</option>
                                        <option>Orthopedic Disability</option>
                                ...
                                <div class="form-group col-md-5" >
                                  <span for="">&nbsp;&nbsp;&nbsp;Please specify,<span class="text-danger"></span></span>
                                    <input type="text" class="form-control" id="other_pwd" name="other_pwd" disabled />
                                </div>
                            </div>
                          </div>
                        </div>
                    ...
                    <div class="box-body">
                      <h5><b><span class="fa fa-file-text"></span>&nbsp;&nbsp;DOCUMENTS</b> (Scanned, Image Type)</h5>
                      <hr/>
                      <div class="box-body" id="doc_form">
                          <div id="img_error">
                          </div>
                          <div class="form-row">
                              ...
                              <div class="form-group col-md-5">
                                 <input type="file" name="pic" class="" id="pic" />
                              </div>
                            </div>
                          ...
                          <div id="other_req">
                            <div class="form-row">
                              <div class="form-group col-md-7">
                                  <span><i class="fa fa-question-circle" data-toggle="tooltip" title="(whichever is applicable)
1. Latest Income Tax Return (ITR) of parents or guardian
2. Certificate of Tax Exemption from the Bureau of Internal Revenue (BIR)
3. Certificate of Indigency from their Barangay with Gross Annual Income
4. Case Study from DSWD or Affidavit of No Income
5. For children of Overseas Filipino Workers (OFW) and Seafarers, a latest copy of contract or proof of income may be considered"></i>&nbsp; Proof of Income </span>
                              </div>
                              <div class="form-group col-md-5">
                                  <input type="file" name="proof_income" id="proof_income">
                              </div>
                            </div>
                            <div class="form-row">
                              <div class="form-group col-md-7">
                              ...
                              <div class="form-group col-md-5">
                                  <input type="file" name="gmc" id="gmc">
                              </div>
                            </div>
                            <div class="form-row">
                              <div class="form-group col-md-7">
                                  <span> Solo-Parent ID or Certification from DSWD </span>
                              </div>
                              <div class="form-group col-md-5">
                                  <input type="file" name="sp_cert" id="sp_cert" disabled >
                              </div>
                            </div>
                          <div class="form-row">
                              <div class="form-group col-md-7">
                                  <span> Certificate from National Commission on Indigenous Peoples (NCIP) </span>
                              </div>
                              <div class="form-group col-md-5">
                                  <input type="file" name="ip_cert" id="ip_cert" disabled >
                              </div>
                            </div>
                          <div class="form-row">
                              <div class="form-group col-md-7">
                                  <span> Medical Certificate for PWD applicants </span>
                              </div>
                              <div class="form-group col-md-5">
                                  <input type="file" name="pwd_cert" id="pwd_cert" disabled >
                              </div>
                            </div>
                          <div class="form-row">
                              <div class="form-group col-md-7">
                                  <span> Affidavit of Guardianship </span>
                              </div>
                              <div class="form-group col-md-5">
                                  <input type="file" name="aff_guard" id="aff_guard" disabled >
                              </div>
                            </div>
 ...
 <script>
        ...
        $(document).ready(function(){
           $("#province").change(function(){
            ...
            $("#gwa").click(function(e){
                e.preventDefault();
                if($("#apptype").val()=='C'){
                  $("#modal_gwa").modal({backdrop:'static',keyboard:false});
                }else{
            ...
            $(".gwa_table").on('click','tr',function(e){
                e.preventDefault();
                var id = $(this).attr('value');
                $("#gwa").val(id);
                
                $("#modal_gwa").modal('hide');
            });
