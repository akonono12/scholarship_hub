...
require_once('tcpdf/tcpdf.php');  
      ...
      $obj_pdf->SetTitle("Application Form");  
...
if ($fetch['app_type'] == 'A'){
					 $school= "HS/Senior High Graduate" ;	
				  }elseif($fetch['app_type'] == 'B'){
				 $school=  "Graduating Senior High" ;		
				  }elseif($fetch['app_type'] == 'C'){
				 $school=  "With Earned Units" ;
            ...
            <hr/>
              ...
              <div class="form-row">
                ...
                <div class="form-group col-md-2">
                  ...
                  <input type="text" class="form-control" id="sex" name="sex" placeholder="" readonly ="enabled" value="'.$gen.'">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-12">
                                            ...
                                            <input type="text" class="form-control" id="fatheredu" name="fatheredu" value= "'.$fetch['F_attain'].'""
 											readonly ="enabled">
                                        </div>
                                    </div>
                      ...
                      <div class="box-body">
                            <div class="form-row">
                                <div class="form-group col-md-5">
                                    ...
                                    <input type="text" class="form-control" id="apptype" name="apptype" readonly ="enabled" value="'.$school.'">
