            ...
            <div class="box box-solid">
              ...
              <div class="box-body no-padding">
                <ul class="nav nav-pills nav-stacked">
                  ...
                  <li class="active"><a href="my-job-post.php"><i class="fa fa-file-o"></i> My Scholarship Post</a></li>
          ...
          <div class="col-md-9 bg-white padding-2">
            <div class="row margin-top-20">
              ...
              <?php
			    ...
			    $scholid=base64_decode(urldecode($_GET['id']));
				 $status=base64_decode(urldecode($_GET['idb']));
               $sql = "SELECT * FROM post_scholar WHERE agency_id='$_SESSION[id_company]' AND scholar_id='$scholid'";
                ...
                ?>
                <div class="pull-left">
                  <h2><b><i>Deadline:<?php echo $row['deadline']; ?></i></b></h2>
                </div>
                ...
                <hr>
                <div>
                  <p><span class="margin-right-10"></span> <i class="fa fa-calendar text-green"></i> <?php echo date("d-M-Y", strtotime($row['TimeCreated'])); ?></p>              
                </div>
                <div>
				...
				if($status=='3'){
					...
					echo '<div class="col-md-3 pull-right">
                      <a href="javascript:void(0);" class="btn btn-danger">This scholarship ended</a>
				</div>';
				}else{
				echo '<div class="col-md-3 pull-right">
                      <a href="upend.php?id=' .$scholid.'" class="btn btn-danger">End the scholarship</a>
				</div>';}
					?>
              </div>
