...
$selDL="SELECT * FROM post_scholar where status = '0'";
$ress=$conn->query($selDL);
if($ress->num_rows>0){
	while($row=$ress->fetch_assoc()){
		$deadline=strtotime($row['deadline']);
		$scid=$row['scholar_id'];
if ($deadline<$cur){
	$upd="Update post_scholar set status = '3' where scholar_id = '$scid' ";
	if($result=$conn->query($upd)){
        ...
        <div class="row">
          ...
          <div class="col-md-9 bg-white padding-2">
            ...
            <div class="alert alert-info alert-dismissible">
                ...
                <i class="icon fa fa-info"></i> In this dashboard you are able to change your account settings, post and manage your scholarships.
            </div>
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="info-box bg-c-yellow">
                  ...
                  <div class="info-box-content">
                    <span class="info-box-text">Scholarship Posted</span>
                    <?php
                    $sql = "SELECT * FROM post_scholar WHERE agency_id='$_SESSION[id_company]'";
              ...
              <div class="col-md-6">
                <div class="info-box bg-c-yellow">
                  ...
                  <div class="info-box-content">
                    <span class="info-box-text">Application For Scholarship</span>
                    <?php
                    $sql = "SELECT * FROM apply_scholar WHERE agency_id='$_SESSION[id_company]'";
                    $result = $conn->query($sql);
