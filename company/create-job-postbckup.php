            ...
            <div class="row">
              <form method="post" action="addpost.php">
                ...
                <div class="form-group">
                  ...
                  <div class="form-group">
                    <input type="number" class="form-control  input-lg" step=".01" id="minGWA" name="minGWA" placeholder="Minimum GWA required" required="">
                  </div>
                  <div class="form-group">
                <input type="number" class="form-control  input-lg" step=".01" id="MAxGWA" autocomplete="off" name="MaxGWA" placeholder="Maximum GWA required" required="">
                  </div>
                  <div class="form-group">
                    <input type="date" class="form-control  input-lg" id="deadline" name="deadline" placeholder="Deadline" required="">
                  </div>
                  <div class="form-group">
