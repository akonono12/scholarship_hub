            ...
            <div class="box box-solid">
              ...
              <div class="box-body no-padding">
                <ul class="nav nav-pills nav-stacked">
                  ...
                  <li class="active"><a href="edit-company.php"><i class="fa fa-tv"></i> Agency</a></li>
          ...
          <div class="col-md-9 bg-white padding-2">
            ...
            <div class="row">
              <form action="update-company.php" method="post" enctype="multipart/form-data">
                <?php
                $sql = "SELECT * FROM agency WHERE Agency_id='$_SESSION[id_company]'";
                ...
                <div class="col-md-6 latest-job ">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control input-lg" name="companyname" value="<?php echo $row['Agency_Name']; ?>" required="">
                  </div>
                  
                  <div class="form-group">
                    <label for="email">Email address</label>
                    <input type="email" class="form-control input-lg" id="email" placeholder="Email" value="<?php echo $row['Email_add']; ?>" readonly>
                  </div>
                  <div class="form-group">
                    <label>About Me</label>
                    <textarea class="form-control input-lg" rows="4" name="aboutme"><?php echo $row['Briefdesc']; ?></textarea>
                  </div>
                  <div class="form-group">
                ...
                <div class="col-md-6 latest-job ">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control input-lg" id="contactno" name="contactno" placeholder="Contact Number" value="<?php echo $row['Agency_Contact']; ?>">
                  </div>
                  <div class="form-group">
                    <label for="city">Address</label>
                    <input type="text" class="form-control input-lg" id="city" name="city" value="<?php echo $row['Agency_Address']; ?>" placeholder="city">
                  </div>
