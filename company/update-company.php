...
if(isset($_POST)) {
	...
	$sql = "UPDATE agency SET 	Agency_Name='$companyname', Agency_Address='$city', Agency_Contact='$contactno', Briefdesc='$aboutme'";

	if($uploadOk == true) {
		$sql = $sql . ", logo='$file'";
	}

	$sql = $sql . " WHERE 	Agency_id='$_SESSION[id_company]'";
