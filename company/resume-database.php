      ...
      <div class="container">
        <div class="row">
            ...
            <div class="box box-solid">
              ...
              <div class="box-body no-padding">
                <ul class="nav nav-pills nav-stacked">
                  ...
                  <li class="active"><a href="resume-database.php"><i class="fa fa-user"></i> Verified Applicants</a></li>
          ...
          <div class="col-md-9 bg-white padding-2">
            <h2><i>Approved Applicants</i></h2>
            <p>In this section you can view the approved applicants  to your scholarship posts</p>
              ...
              <div class="col-md-12">
                <div class="box-body table-responsive no-padding">
                  <table id="example2" class="table table-hover">
                    ...
                    <tbody>
                    <?php
                       $sql = "SELECT  *,apply_scholar.gwa as apgwa FROM `apply_scholar` inner JOIN post_scholar on apply_scholar.scholar_id=post_scholar.scholar_id inner join applicant on applicant.Applicant_id=apply_scholar.Applicant_id where post_scholar.agency_id = '$_SESSION[id_company]' AND apply_scholar.status = 3 ";
