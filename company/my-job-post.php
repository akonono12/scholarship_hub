      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-9 bg-white padding-2">
            <h2><i>My Scholarship Posts</i></h2>
            <p>In this section you can view all scholarship posts created by you.</p>
                     ...
                     $sql = "SELECT * FROM post_scholar WHERE agency_id='$_SESSION[id_company]'";
                      ...
                      <tr>
					   <td><?php echo $row['scholar_id']; ?></td>
						...
						?></td>
					    <td><a href="view-job-post.php?id=<?php echo urlencode(base64_encode($row['scholar_id'])); ?>&idb=<?php echo urlencode(base64_encode($row['Status']));?>"><i class="fa fa-address-card-o"></i></a></td>
                      </tr>
                      <?php
                       }
                     }
