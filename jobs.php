...
<div class="wrapper">
    ...
    <section class="content-header">
      <div class="container">
        <div class="row">
          ...
          <h1 class="text-center">Latest Scholarships</h1>  
            <div class="input-group input-group-lg">
                <input type="text" id="searchBar" class="form-control" placeholder="Search Agency ">
          ...
          $sql = "SELECT COUNT(scholar_id) AS id FROM post_scholar where post_scholar.Status  = '0'";
  ...
  <footer class="main-footer" style="margin-left: 0px;">
    <div class="text-center">
      <strong>Copyright &copy; 2018-2019 <a href="learningfromscratch.online">Job Portal</a>.</strong> All rights
    reserved.
    </div>
  </footer>
