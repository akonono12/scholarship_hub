      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-9 bg-white padding-2">
            ...
            $sql = "SELECT * FROM applicant WHERE Applicant_id='$_SESSION[id_user]'";
              ...
              <div class="row">
                ...
                <div class="col-md-6 latest-job ">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control input-lg" id="contactno" name="contactno" placeholder="Contact Number" value="+63<?php echo $row['con_no']; ?>">
                  </div>
