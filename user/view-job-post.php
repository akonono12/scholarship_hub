...
$sql = "SELECT * FROM apply_scholar WHERE Applicant_id='$_SESSION[id_user]' AND scholar_id='$_GET[id]'";
$result = $conn->query($sql);
if($result->num_rows > 0) 
{
  
  $sql1 = "SELECT * FROM post_scholar INNER JOIN agency ON post_scholar.agency_id=agency.Agency_id WHERE scholar_id='$_GET[id]'";
      ...
      <div class="container">
        <div class="row">          
          <div class="col-md-9 bg-white padding-2">
            <div class="pull-left">
              <h2><b><i><?php echo $row['Agency_Name']; ?></i></b></h2>
            </div>
