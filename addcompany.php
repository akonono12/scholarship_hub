...
if(isset($_POST)) {
	...
	if($result->num_rows == 0) {
		...
		$sql = "INSERT INTO agency(Handler_Name, Agency_Name, Agency_Contact, Briefdesc, Email_add, Password, logo,TimeCreated, Agency_Address) VALUES ('$name', '$companyname', '$contactno', '$aboutme', '$email', '$password', '$file', Now(), '$address')";
