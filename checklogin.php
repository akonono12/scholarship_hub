...
if(isset($_POST)) {
	...
	$sql = "Select * from applicant where email_add='$email' and Password='$password'";
	...
	if($result->num_rows > 0) {
		...
		while($row = $result->fetch_assoc()) {
				...
				$_SESSION['id_user'] = $row['Applicant_id'];
 		...
 		header("Location: login-candidates.php?id='.$email.'&&'.$password.'");
		exit();
 	}
