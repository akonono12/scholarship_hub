        ...
        <div class="row latest-job margin-top-50 margin-bottom-20 bg-white">
          ...
          <form method="post" id="registerCompanies" action="addcompany.php" enctype="multipart/form-data">
            <div class="col-md-6 latest-job ">
              ...
              <div class="form-group">
                <textarea class="form-control input-lg" rows="4" name="aboutme" placeholder="Brief info about the agency"></textarea>
              </div>
            ...
            <div class="col-md-6 latest-job ">
			  ...
			  <div class="form-group">
                <input class="form-control input-lg" type="text" name="address" placeholder="Agency Address" required>
              </div>
              <div class="form-group">
                <label>Attach Agency Logo</label>
